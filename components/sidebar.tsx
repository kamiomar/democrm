...
import { LayoutDashboard, Users, Kanban, BarChart3, Settings, ChevronDown, Zap, UserRound, Shield, TrendingUp } from 'lucide-react'
...
const roleStyle: Record<UserRole, string> = {
  ...
  'Sales Manager': 'bg-indigo-500/10 text-indigo-400',
  'Sales Rep':     'bg-emerald-500/10 text-emerald-400',
}
        ...
        <Link href="/team"
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 mt-0.5">
              <RoleIcon size={9} className={roleStyle[CURRENT_USER.role].split(' ')[1]} />
              <p className={cn('text-[10px] font-medium truncate', roleStyle[CURRENT_USER.role].split(' ')[1])}>
                {CURRENT_USER.role}
              </p>
            </div>
          </div>
